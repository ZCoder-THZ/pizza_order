            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button id="addCartBtn" class="btn btn-outline-primary px-3 "><i
                    ...
                    @foreach ($pizzaList as $p)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img style="height: 250px" class="img-fluid w-100" src="{{ asset('storage/' . $p->image) }}"
                                    alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square addItem" href="{{ $p->id }}"><i
                                            class="fa fa-shopping-cart"></i></a>
                                    <input type="hidden" name="" id="pId" value="{{ $p->id }}">
                                    <input type="hidden" name="" id="uId" value="{{ Auth::user()->id }}">
