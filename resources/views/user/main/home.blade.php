                    ...
                    <form>
                        ...
                        @foreach ($categories as $category)
                            <div class="d-flex align-items-center justify-content-between mb-3 shadow-sm pt-2">
                                <a class="text-dark" href="{{ route('user#filter', $category->id) }}"
                                    for="price-all">{{ $category->name }}</a>
                    ...
                    <div class="col-12 pb-1">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                ...
                                <a href="{{ route('user#contactPage') }}"type="button"
                    ...
                    <span class="row" id="dataList">
                        @if (count($pizzas) != 0)
                                        ...
                                        <div class="product-img position-relative overflow-hidden">
                                            ...
                                            <div class="product-action">
                                                ...
                                                <input type="hidden" name="" value="{{ Auth::user()->id }}"
                                                    id="userId">
                                                <a class="addItem btn btn-outline-dark btn-square"
                                                    href="{{ $pizza->id }}"><i class="fa fa-shopping-cart"></i></a>
                         ...
                         <small class="fa fa-star text-primary mr-1"></small>
                            ...
                            @endforeach
                        @else
                            <p class="text-center col-6 fs-1 offset-3 py-5 shadow-sm ">There is no pizza <i
