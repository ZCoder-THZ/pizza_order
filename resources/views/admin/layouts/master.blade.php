            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                      ...
                      <li>
                        <a href="{{route('admin#contacts')}}" style="text-decoration: none">
                        <i class="fa-solid fa-users">
                        </i>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <form class="my-3 d-flex justify-content-center" action="{{route('logout')}}" method="post">
                                                    @csrf
                                                    <button class="btn btn-dark col-10" type="submit"> <i class="zmdi zmdi-power"></i>Logout</button>
                                                </form>
